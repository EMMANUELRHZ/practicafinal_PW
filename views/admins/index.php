...
<h1 class="center" style="text-align:center;background: #3498db;color: #fff;padding: 5px 15px;" >Admins</h1>
...
<table class="table table-sm">
               ...
               <tr>
                         ...
                         <th>Fotografía</th>
                         <th></th>
                         <th><a href="<?php echo constant('URL'); ?>nuevoadmin">Nuevo Admin</a></th>
                     </tr>
               </thead>
               ...
               ?>
                 ...
                 <td><?php echo $alumno->nombre; ?></td>
                   ...
                   href="<?php echo constant('URL') . 'admins/verAlumno/' . $alumno->matricula; 
                   ?>" >Editar </a>
                   <!--<td><a href="<?php echo constant('URL') . 'admins/eliminarAdmin/' . $alumno->matricula; ?>">Eliminar </a></td>-->
